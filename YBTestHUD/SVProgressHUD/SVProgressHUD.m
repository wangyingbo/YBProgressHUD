...
//#warning clang - change this code by myself,I am not sure whether this bring some new bugs - wangyingbo
            [self.frontWindow addSubview:self.controlView];
//            [[UIApplication sharedApplication].keyWindow addSubview:self.controlView];
#else
